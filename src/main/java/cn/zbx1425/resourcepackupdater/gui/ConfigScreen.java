...
public class ConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        Button btnReload = new Button(PADDING + btnWidthOuter + PADDING, 40, btnWidthInner, 20, Text.translatable("更新并重载"), (btn) -> {
    ...
    public void render(@NotNull PoseStack matrices, int mouseX, int mouseY, float delta) {
        if (isShowingLog) {
            ...
            this.font.drawShadow(matrices, "源服务器:", 20, 76, 0xFFFFFFFF);
            this.font.drawShadow(matrices, "https://lx.gteh.top", 20, height - 40, 0xFFFFFFFF);
